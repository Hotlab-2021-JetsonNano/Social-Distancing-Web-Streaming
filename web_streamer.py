...
class Streamer :
    def __init__(self):
        ...
        print('[hotlab] ', 'OpenCL : ', cv2.ocl.haveOpenCL())
        ...
        #hotlab
        model = str('yolov4-tiny-3l-crowd-416')
        self.trt_yolo = TrtYOLO(model, 80, False)
        self.frameData = FrameData()
        
    def run(self, src = 0) :
        self.stop()

        src = "source_video/people-640p.mp4"
    ...
    def process(self, frame):
        boxes, confs, clss = self.trt_yolo.detect(False, frame, 0.3)
